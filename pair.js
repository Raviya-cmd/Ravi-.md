...
const config = {
    ...
    RCD_IMAGE_PATH: './https://i.ibb.co/8nCdBSRr/Supunmd.jpg',
...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'Raviya-cmd';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'Ravi .md';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
